...
//cross section for spin-dependent wimp nucleus scattering with zero momentum transfer
	extern double sigmaSD(double mX,double sigman0,double A,double J,double Sp,double Sn, double ap, double an);	
//Total Wimp Nucleus Cross-section:
	extern double TotalsigmaSI(double mX,double sigman0,double A,double vX=0.0);
//Total Wimp spin-dependent Nucleus Cross-section:	
	extern double TotalsigmaSD(double mX,double sigman0,double A,double vX,double J,double Sp,double Sn, double ap, double an);	
